...
import { CheckCircle2, AlertCircle, ArrowLeft, RefreshCw, Eye, EyeOff, ShieldCheck, Lock } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (onSuccessLogin && tokenInfo?.email) {
          onSuccessLogin(tokenInfo.email);
        }
      } else {
