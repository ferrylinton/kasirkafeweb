...
import { Receipt, Mail, Send, CheckCircle2, AlertCircle, RefreshCw, Eye, X, Printer, DollarSign, ShoppingBag } from 'lucide-react';
...
export const OrderHistoryScreen: React.FC<OrderHistoryScreenProps> = ({ allVendorsMode = false }) => {
  const { token } = useAuth();
